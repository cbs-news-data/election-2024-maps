...
all_counties_clean <- all_counties %>% 
  ...
  select(fips, name, state, precinctsOf, precinctsIn, pctPrecIn, pctExpVote, totalVote, `vote_Joe Biden`, `vote_Donald Trump`, vote_Other, `pct_Joe Biden`, `pct_Donald Trump`, pct_Other, ts) %>%  #select only the columns we want
